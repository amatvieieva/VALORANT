    ...
    <ThemeProvider attribute="class" defaultTheme="system" enableSystem>
      <Provider store={store}>
        <PersistGate loading={null} persistor={persistor}>
          <header className="py-4 px-8 text-white bg-zinc-900 flex justify-between items-center gap-4 relative z-10">
            <Link href={'/'}>
              <svg width="85" height="27" className="_32ANSIZormifc9Vc6VVwrx" viewBox="0 0 587.93 165">
            ...
            <nav style={{ flexGrow: '0.4' }}>
              <ul className="flex gap-4 text-lg">
                <li className="p-2" style={{ borderBottom: pathName === '/' ? '2px solid #ff4655' : 'none' }}>
                  <Link href="/">Leaderboard</Link>
                </li>
                <li className="p-2" style={{ borderBottom: pathName.includes('/news') ? '2px solid #ff4655' : 'none' }}>
